...
class FaqSemanticMatcherService
{
    ...
    function (Faq $faq) {
        ...
        return [
            ...
            'agency_name' => $faq->agency?->agency_name,
...
You MUST use agency compatibility, keyword relevance, question meaning, and intent compatibility when selecting a FAQ.

AGENCY RULES:
- If a current agency context is supplied by Laravel, prefer only candidates from that agency.
- If the user explicitly names an agency, the candidate agency must match that agency.
- Do not select an FAQ merely because its agency name is similar to another agency.

KEYWORD RULES:
- Treat the administrator-provided keywords as strong domain vocabulary.
- Compare keywords to the user's wording, including Filipino/Taglish equivalents.
- Keywords are supporting evidence; they are not sufficient without matching the question's meaning and intent.
...
After checking agency and intent compatibility, compare the actual
meaning of the user's question with the candidate question and
